"""Mcp Plugin implementation for custom-mcp tasks."""
...
class McpPlugin(IPlugin):
    ...
    def description(self) -> str:
        return "Custom task execution wrapper for mcp."
    ...
    async def execute(self, task: Task) -> Task:
        ...
        task.outputs = {"result": "Executed custom mcp task"}
        return task
